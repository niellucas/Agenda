                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-10">
                            ...
                            <div class="wow fadeInUp" data-wow-delay="0.4s">
                                <form id="formAtualizarEndereco"  action="AtualizarEndereco" method="post">
                                    <div class="col-md-12 col-sm-12">
                                        <input type="text" class="form-control" name="id" placeholder="ID do Endereço" required="" id="formControl">
                                    </div>
