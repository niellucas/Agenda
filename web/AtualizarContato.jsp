                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-10">
                            ...
                            <div class="wow fadeInUp" data-wow-delay="0.4s">
                                <form id="formAtualizarContato" action="AtualizarContato" method="post">
                                    <div class="col-md-12 col-sm-12 col-xs-12 ">
                                        <input type="text" class="form-control" name="nome" placeholder="Nome" required="" id="formControl">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" name="cargo" placeholder="Cargo" required="" id="formControl">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" name="empresa" placeholder="Empresa" required="" id="formControl">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" name="dataAniversario" placeholder="Dia/Mês/Ano" required="" id="formControl">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" name="idContato" placeholder="ID Contato" required="" id="formControl">
                                    </div>
