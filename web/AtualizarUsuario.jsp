...
<html>
    <head>
        ...
        <title>DiaryBOOK - Atualizar Dados da Conta</title>
                            ...
                            <div class="wow fadeInUp" data-wow-delay="0.4s">
                                <form name="formAtualizarUsuario" method="post" action="AtualizarUsuario" >
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" name="login" placeholder="Login" required="" id="formControl">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" name="senha" placeholder="Senha" required="" id="formControl">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" name="id" placeholder="Id" required="" id="formControl">
                                    </div>
                                    <div class="col-md-offset-8 col-md-4 col-sm-offset-6 col-sm-6">
                                        <button  type="submit" class="form-control" name="submit" id="btCad">Atualizar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
