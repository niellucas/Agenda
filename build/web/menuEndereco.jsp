...
<html>
    <head>
        ...
        <title>DiaryBOOK - Menu Endereço</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="wow fadeInUp section-title" data-wow-delay="0.2s">
                                <h2>Menu Endereço</h2>
                                <p>Selecione uma das opções a seguir</p>
                            </div>
                        </div>
                            ...
                            <div class="wow fadeInUp" data-wow-delay="0.4s">
                                <div class="col-md-offset-8 col-md-4 col-sm-offset-6 col-sm-6">
                                    <a href="CadastrarEndereco.jsp">
                                        <button  type="submit" class="form-control" id="btCad" >Cadastrar</button>
                                    </a>
                                </div>
                                <div class="col-md-offset-8 col-md-4 col-sm-offset-6 col-sm-6">
                                    <a href="AtualizarEndereco.jsp">
                                        <button  type="submit" class="form-control" name="submit" id="btCad">Atualizar</button>
                                    </a>
                                </div>
                                <div class="col-md-offset-8 col-md-4 col-sm-offset-6 col-sm-6">
                                    <a href="DeletarEndereco.jsp">
