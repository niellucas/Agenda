                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="wow fadeInUp section-title" data-wow-delay="0.2s">
                                ...
                                <p>Esperamos que volte logo! BYE</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-7 col-sm-10">
                            ...
                            <div class="wow fadeInUp" data-wow-delay="0.4s">
                                <form name="formCadastrarMeioContato" action="CadastrarMeioContato">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" class="form-control" name="tipoContato" placeholder="Tipo de Contato" required="" id="formControl">
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" class="form-control" name="conteudo" placeholder="Conteúdo" required="" id="formControl">
                                    </div>
